...
Java_com_termux_x11_CmdEntryPoint_start(JNIEnv *env, __unused jclass cls, jobjectArray args) {
    ...
    setenv("LD_PRELOAD", "/data/data/com.termux/files/usr/opt/angle-android/vulkan-null/libEGL.so.1", 1);
    setenv("LD_PRELOAD", "/data/data/com.termux/files/usr/opt/angle-android/vulkan-null/libGLESv2.so.2", 1);
